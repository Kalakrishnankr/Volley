...
public class UserProfile {
    ...
    @SerializedName("toursPlayesInArr")
    private List<String> ToursPlayesInArr;
    ...
    public void setCbvaPlayerNumber(String cbvaPlayerNumber) {
        CbvaPlayerNumber = cbvaPlayerNumber;
    }
    ...
    public void setCourtSidePreference(String courtSidePreference) {
        CourtSidePreference = courtSidePreference;
    }
    ...
    public void setHighSchoolAttended(String highSchoolAttended) {
        HighSchoolAttended = highSchoolAttended;
    }
    ...
    public void setHighestTourRatingEarned(String highestTourRatingEarned) {
        HighestTourRatingEarned = highestTourRatingEarned;
    }
    ...
    public void setIndoorClubPlayed(String indoorClubPlayed) {
        IndoorClubPlayed = indoorClubPlayed;
    }
    ...
    public void setTournamentLevelInterest(String tournamentLevelInterest) {
        TournamentLevelInterest = tournamentLevelInterest;
    }
    ...
    public void setToursPlayedIn(String toursPlayedIn) {
        ToursPlayedIn = toursPlayedIn;
    }

    public List<String> getToursPlayesInArr() {
        return ToursPlayesInArr;
    }

    public void setToursPlayesInArr(List<String> toursPlayesInArr) {
        ToursPlayesInArr = toursPlayesInArr;
    }
    ...
    public void setUsaVolleyballRanking(String usaVolleyballRanking) {
        UsaVolleyballRanking = usaVolleyballRanking;
    }
