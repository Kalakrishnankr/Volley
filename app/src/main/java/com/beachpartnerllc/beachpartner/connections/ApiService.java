...
public class  ApiService {
  ...
  // public static String BASE_URL   =    "http://192.168.0.34:8080/api/" ;
    ...
    public static String GET_USER_ACTIVE_PLANS   =  BASE_URL+"users/active-plans";
    ...
    public static String GET_SUBSCRIPTION_PLANS    =   BASE_URL+"payment/subscription-plans";
    public static String GET_SUBSCRIBED_ADDONS     =   BASE_URL+"payment/addon-plans";
